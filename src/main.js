...
import SupplyChainLanding from "@/pages/Cases/supplychain/SupplyChainLanding.vue";
...
const routes = [
  {
    ...
    children: [
      ...
      { path: "cases/government-landing", component: GovernmentLanding },
      { path: "cases/supplychain-landing", component: SupplyChainLanding },
