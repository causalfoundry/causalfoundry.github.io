        ...
        <div class="members">
          <div v-for="member of team" class="member">
            ...
            <div class="info">
              ...
              <div class="links">
                <a v-if="member.links.linkedin" :href="member.links.linkedin">
                  <img
                    src="../../assets/linkedin-about.png"
                    class="link linkedin"
                  />
                </a>
                <a v-if="member.links.twitter" :href="member.links.twitter">
                  <img
...
const team = [
  {
    imageUrl: "/src/assets/africa.png",
    name: "África Periáñez",
    role: "CEO & Founder",
    descritpion: `Sumiko is the COO at Causal Foundry. She brings extensive experience in
      working globally with international institutions, nonprofit
      organizations, and corporate businesses. Her focus includes ensuring
      the effective implementation of projects and programs, and the successful
      management of partnerships. She holds a BA in International Relations
      from the University of Washington and a dual master’s degree in strategic
  ...
  {
    imageUrl: "/src/assets/dexian.png",
    name: "Dexian Tang",
    role: "CTO & Co-Founder",
    descritpion: `Sumiko is the COO at Causal Foundry. She brings extensive experience in
      working globally with international institutions, nonprofit
