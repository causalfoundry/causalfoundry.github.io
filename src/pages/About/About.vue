    ...
    <div class="container">
      ...
      <div class="jumbotron">
        ...
        <div class="description">
          <div>
            We are a public benefit corporation with a mission to scale advanced AI technology.
          </div>
          <div>
            Built on our own research and engineering, our platform and scientists use models to predict clinical and
            behavioral outcomes and deliver adaptive interventions based on data generated by digital devices, clinical
            records along with other contextual information. These interventions are distributed directly to patients
            and providers through digital tools such as personalized recommendations, reminders, incentives, or
            integrated content and workflows within the applications.
          </div>
          <div>
            Our goal is to ensure that each intervention is not just effective but also specifically tailored to the
            needs and circumstances of each recipient.
          </div>
        </div>
      </div>
      ...
      <div class="our-story">
        ...
        <div class="our-story__content">
          <div class="our-story__section">
            ...
            <br/><br/>
            2020 marked a transformative year for África and Dexian. Together they transitioned their focus to a domain
            with profound global impact – AI for global health. Since then, they have been relentless in pushing the
            boundaries of what AI can achieve and who can access it.
            <br/><br/>
