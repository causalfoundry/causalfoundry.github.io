<template>
  <div class="privacy-policy">
    <div class="container">
      ...
      <AppHeader current-page="privacy-policy">
        <AppMenu />
      </AppHeader>

      <div class="content">
        <h1>Privacy Policy</h1>
        <div class="date">Last updated: February 14, 2024</div>
        ...
        <ul class="wide">
          ...
          <li>
            ...
            this Agreement) refers to Causal Foundry SL, C/ Valencia 310, 3, 1,
          ...
          <li>
            Website refers to Causal Foundry, accessible from causalfoundry.ai
          </li>
          <li>
