  ...
  <div class="careers">
    <div class="container">
        ...
        <div class="job">
          ...
          <div class="job__info">
            <div class="job__description">
              ...
              background to join our engineering team to build our data
              infrastructure. You will have the rare opportunity to build
              resilient and scalable machine learning products from scratch,
              together with other talented engineers, to achieve equity in
              health for all people worldwide via cutting-edge ML algorithms.
            </div>
            <a
              target="_blank"
              href="https://candy-silica-cf0.notion.site/Senior-Software-Engineer-Data-ML-c25aa672855c42c7b079f938d0a8fd11"
      ...
      <div class="careers__culture">
        ...
        <a
          target="_blank"
          href="https://candy-silica-cf0.notion.site/Our-Interview-Process-1e8f13ac941043e59dd28506712a967f"
